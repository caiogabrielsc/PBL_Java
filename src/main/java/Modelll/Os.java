...
public class Os implements Serializable {
    public Os(int id, Client client, Attendant attendant, Technician technician, String description, int status, double finalvalue, String payment, int satisfaction, long createtime, long starttime, long finishtime) {
        this.id = id;
        this.client = client;
